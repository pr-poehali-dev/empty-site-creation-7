  ...
  <div className="space-y-3">
    ...
    <Section title="Готовые правила обработки">
      ...
      <div className="rounded-lg border border-white/[0.08] p-3">
        ...
        <p>
          Результат: один лист «Товары», семь колонок в строгом порядке — артикул,
          наименование, количество, цена, страна, номер ГТД, номер РНПТ.
        </p>
        <p>
          Над таблицей, в первой строке листа, — номер и дата документа поставщика.
        </p>
        <p>
          Артикул берётся из отдельной колонки, а если её нет — выдёргивается из
          наименования{" "}
