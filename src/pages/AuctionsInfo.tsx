  ...
  <div className="space-y-6 text-sm leading-relaxed">
    ...
    <div>
      ...
      <p className="text-muted-foreground">
        ...
        название, описание, фото, желаемая цена, количество, срок окончания и срок на оплату для
        победителя. У каждого лота есть статус (идёт / закрыт / на оплате / завершён / отменён).
      </p>
    </div>
