...
const OdataExchange = () => {
  ...
  const doFind = async () => {
    ...
    setFindError("");
    try {
      const r = await odataApi.findProduct(article.trim());
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 sm:py-8">
        ...
        <Tabs defaultValue="tests">
          ...
          <TabsContent value="tests" className="space-y-4">
            ...
            <DocTest kind="product" title="Тестовая номенклатура" icon="Package" isProduct />
          </TabsContent>
        </Tabs>
      </main>
    </div>
