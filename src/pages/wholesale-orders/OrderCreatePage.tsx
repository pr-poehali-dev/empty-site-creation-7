            ...
            {showDropdown && (
              <div className="absolute top-full left-0 right-0 z-50 mt-1 border border-white/[0.08] rounded-xl bg-orange-950 overflow-hidden max-h-72 overflow-y-auto shadow-lg">
                ...
                {searchResults.map((item, idx) => (
                  ...
                  >
                    <div className="min-w-0">
                      <span className="block break-words"><span className="text-muted-foreground">{searchResults.length - idx}.</span> {item.name}</span>
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-start gap-1.5">
                        <p className="text-sm break-words min-w-0">{line.name}</p>
                        {isRedLine && (
