...
import ReceivingCatalog from "./pages/ReceivingCatalog";
...
import OdataBase from "./pages/OdataBase";
import OdataTests from "./pages/OdataTests";
import OdataSupplierInvoice from "./pages/OdataSupplierInvoice";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin/receiving-catalog" element={<NotForWholesaler><ReceivingCatalog /></NotForWholesaler>} />
