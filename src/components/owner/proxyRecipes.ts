...
export default {
  fetch: relay,
    ...
    steps: [
      ...
      {
        title: "Создать Worker",
        text: "В левом меню найдите «Workers & Pages» (может называться «Compute»). Нажмите «Create application», затем «Create Worker».",
      },
      {
        title: "Имя",
        text: "Придумайте имя латиницей, например tg-relay — оно станет частью адреса. Нажмите «Deploy» и подождите пару секунд.",
      },
      {
        title: "Вставить код",
        text: "Нажмите «Edit code». В редакторе будет чужой пример — щёлкните по нему, нажмите Ctrl+A и Delete. Затем скопируйте код ниже и вставьте (Ctrl+V).",
      },
      {
        title: "Опубликовать",
        text: "Нажмите «Deploy» справа сверху и подтвердите. Через несколько секунд посредник заработает.",
      },
      {
        title: "Забрать адрес",
        text: "Вернитесь на страницу Worker'а. Там будет адрес вида tg-relay.ваше-имя.workers.dev — скопируйте его.",
      },
    ],
